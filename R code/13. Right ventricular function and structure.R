...
plot_RVESPAR <- generate_plot(data, "RVESPAR_high", "bold(RVESPAR[high]*' (mmHg/cm²)')", seq(0,  60, by = 5), c(0, 41))
plot_TAPSE <- generate_plot(data, "TAPSE_high", "bold(TAPSE[high]*' (/)')", seq(0,  60, by = 5), c(0, 50))


# Combine the plots using cowplot
combined_plot <- plot_grid(plot_RVESPAR, plot_TAPSE, ncol = 1, align = "v")
...
ggsave("Right ventricular function.png", final_plot, dpi = 900, width = 9, height = 9/4)
