...
plot_BPS <- generate_plot(data, "BPs_high", "bold(SBP[high]*' (mmHg)')", seq(100,  280, by = 20))
plot_BPD <- generate_plot(data, "BPd_high", "bold(DBP[high]*' (mmHg)')", seq(40,  180, by = 20))


# Combine the plots using cowplot
combined_plot <- plot_grid(plot_BPD, plot_BPS, ncol = 1, align = "v")
...
ggsave("Blood pressure.png", final_plot, dpi = 900, width = 9, height = 9/4)
